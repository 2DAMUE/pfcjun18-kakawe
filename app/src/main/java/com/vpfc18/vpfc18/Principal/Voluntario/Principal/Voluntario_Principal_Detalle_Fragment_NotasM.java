...
public class Voluntario_Principal_Detalle_Fragment_NotasM extends Fragment {
    ...
    int id_alerta;
    View vista;
    Button bt_perfil_voluntario_notas_m_guardar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bt_perfil_voluntario_notas_m_guardar = (Button)vista.findViewById(R.id.bt_perfil_voluntario_notas_m_guardar);
        bt_perfil_voluntario_notas_m_guardar.setOnClickListener(new View.OnClickListener() {
            @Override
