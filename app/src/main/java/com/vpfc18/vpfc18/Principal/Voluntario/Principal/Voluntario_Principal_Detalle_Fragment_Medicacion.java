 ...
 */
public class Voluntario_Principal_Detalle_Fragment_Medicacion extends Fragment {


    String correoUser,id_correoAsistido,telefono,nombreAsistido;
    int id_alerta;
    View vista;
    Button bt_perfil_voluntario_medicacion_guardar;

    public Voluntario_Principal_Detalle_Fragment_Medicacion() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.voluntario_fragment_principal_detalle_medicacion, container, false);
        ...
        bt_perfil_voluntario_medicacion_guardar = (Button)vista.findViewById(R.id.bt_perfil_voluntario_medicacion_guardar);
        bt_perfil_voluntario_medicacion_guardar.setOnClickListener(new View.OnClickListener() {
            @Override
